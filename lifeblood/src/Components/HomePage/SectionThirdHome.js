      ...
      <div className={styles.container}>
        ...
        <div className={styles['container-text']}>
          ...
          <div className={styles['about-us']}>
            ...
            <div>It uses a dictionary of over 200 Latin words, combined with a handful of
              model sentence structures, to generate Lorem Ipsum which looks reasonable.All
