  ...
  return  (
    ...
    <div className="createFormContainer">
        <div className="createForm">
            <form onSubmit={formsubmitHandler} className="createForm1">
                ...
                <GoogleLogin
                 ...
                 <div className="createFormFill">
                    ...
                    <input type="number" name="phone" value={enteredPhone} onBlur={phoneBlurHandler} onChange={phoneChangeHandler}></input>
                    ...
                    <span>Pincode</span>
                    <input type="number" name="pincode" value={enteredPinCode} onBlur = {pinCodepBlurHandler} onChange = {pinCodeChangeHandler} required></input>
                    <span>Email</span>
